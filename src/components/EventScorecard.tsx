  ...
  return (
    <div className="max-w-md mx-auto p-4">
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h2 className="text-2xl font-bold text-center mb-6 text-gray-900">My Scorecard</h2>
        
        <div className="grid grid-cols-3 gap-2 mb-6 text-center">
          <div className="bg-blue-100 rounded p-2">
            <div className="text-xs text-gray-700">Strokes</div>
            <div className="text-xl font-bold text-gray-900">{totals.strokes}</div>
          </div>
          <div className="bg-orange-100 rounded p-2">
            <div className="text-xs text-gray-700">Hot Dogs</div>
            <div className="text-xl font-bold text-gray-900">{totals.hotDogs}/9</div>
          </div>
          <div className="bg-yellow-100 rounded p-2">
            <div className="text-xs text-gray-700">Beers</div>
            <div className="text-xl font-bold text-gray-900">{totals.beers}/9</div>
          </div>
        </div>
        ...
        <div className="space-y-4 border-t pt-4">
          <h3 className="text-lg font-semibold text-center text-gray-900">Hole {currentHole}</h3>
          
          <div>
            <label className="block text-sm font-medium mb-1 text-gray-800">Strokes</label>
            <input
              type="number"
              min="1"
              max="20"
          ...
          <div>
            <label className="block text-sm font-medium mb-1 text-gray-800">Hot Dogs Consumed</label>
          ...
          <div>
            <label className="block text-sm font-medium mb-1 text-gray-800">Beers Consumed</label>
            <div className="flex gap-2">
              {[0, 1, 2, 3].map(num => (
                <button
                  key={num}
          ...
          {currentScore.beers_consumed > 0 && (
            <div>
              <label className="block text-sm font-medium mb-1 text-gray-800">Beer Type</label>
              <select
